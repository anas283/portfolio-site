  ...
  render() {
    return (
      <div className="flex justify-center bg-gray-100 w-full h-screen">
        <div className="w-full px-6 mt-24 md:w-3/5 md:mt-32">
          <h1 className="text-6xl font-bold">Hello I'm Anas</h1>
          <p className="w-11/12 font-hairline text-gray-700 text-md mt-4 md:w-3/5 md:text-lg">
          ...
          <div className="w-full flex items-center flex-col mt-24 md:items-start md:mt-2 md:flex-row">
